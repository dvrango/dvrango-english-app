...
const SunIcon = () => (
  <SunIconSvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
const NavButton = styled.button<{ $isActive: boolean }>`
  ...
  background-color: ${(props) =>
    props.$isActive ? "#fbbf24" : "rgba(255, 255, 255, 0.6)"} !important;
  color: ${(props) => (props.$isActive ? "#ffffff" : "#4b5563")} !important;
  box-shadow: ${(props) =>
    props.$isActive ? "0 10px 15px -3px rgba(0, 0, 0, 0.1)" : "none"};

  &:hover {
    background-color: ${(props) =>
      props.$isActive ? "#fbbf24" : "rgba(255, 255, 255, 0.9)"} !important;
  ...
  return (
    <Container>
      <MainCard>
        <Header>
          <SunIcon />
          <StudentTitle>DgoTecHub ECC</StudentTitle>
        </Header>
